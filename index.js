...
if(getno(a)==z && getno(b)==z && getno(c)==z)
return true
else
return false
 }
 function check(){
    ...
    ||checkmove(1,5,9,sign)||checkmove(7,5,3,sign)){
        ...
        document.getElementById("winner").innerHTML=`Player ${sign} is the Winner`
        
    }
    else{
        if(getno(1)!=""&& getno(2)!=""&& getno(3)!=""&&
        getno(4)!=""&& getno(5)!=""&& getno(6)!=""&&
        getno(7)!=""&& getno(8)!=""&& getno(9)!=""){
            console.log('again')
